        ...
        <div class="row mt-3">
            <div class="col-2 p-2 " style="height: 100vh">
                <ul class="nav flex-column m-auto">
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-info py-2 mb-1" href="#">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-info py-2 mb-1 active" href="#">Manage
                            Product</a>
                    </li>
                    <li class="nav-item">
                                ...
                                <form class="form form-horizontal" action="{{ route('products.store') }}">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 mb-1 form-group">
                                                <input type="file" class="form-control" name="img" accept=".png,.pdf.jpeg,.jpg">
                                            </div>
